<?php
  if(isset($_POST['staffcode'])){
    ...
    $deleteq = "UPDATE employees SET emp_status = 'Inactive' where emp_staffcode = :stfcd";
    ...
    $sth->execute(array(
      ':stfcd' => $staffCode,
      ':stfcnm' => $staffname,
      ':activity' => "Deactivated employee with the staff code '$staffcode' in using this IP ". $_SERVER['REMOTE_ADDR'],
      ':dt' => $datetime
